...
namespace RechargeTools.Tasks
{
    ...
    public partial interface IScheduleTaskService
    {
        ...
        List<ScheduleTaskHistory> GetHistoryEntries(
            int pageIndex,
            int pageSize,
            Guid taskId,
        ...
        ScheduleTaskHistory GetLastHistoryEntryByTaskId(Guid taskId, bool? isRunning = null);
        ...
        /// <returns><see cref="ScheduleTaskHistory"/> entry.</returns>
        ScheduleTaskHistory GetHistoryEntryById(Guid id);
