...
using RechargeTools.Infrastructure.DependencyManagement;
...
namespace RechargeTools.Async
{
    public static class AsyncRunner
    {
        ...
        private static ContainerManager _containerManager = new ContainerManager(builder.Build());
        ...
        public static Task Run(Action<ILifetimeScope, CancellationToken> action, CancellationToken cancellationToken, TaskCreationOptions options, TaskScheduler scheduler)
        {
            ...
            {
                var accessor = _containerManager.ScopeAccessor;
