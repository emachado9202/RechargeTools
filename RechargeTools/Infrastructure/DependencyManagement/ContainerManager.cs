...
namespace RechargeTools.Infrastructure.DependencyManagement
{
    public class ContainerManager
    {
        ...
        public ContainerManager(IContainer container)
        {
            ...
            Logger = LogManager.GetLogger(typeof(ContainerManager));
        }
        ...
        public object ResolveUnregistered(Type type, ILifetimeScope scope = null)
        {
            ...
            throw new Exception("No constructor for {0} was found that had all the dependencies satisfied.".FormatInvariant(type.Name.NaIfEmpty()));
        }
    ...
    public static class ContainerManagerExtensions
    {
        ...
        {
            return registration.WithParameter(Autofac.Core.ResolvedParameter.ForNamed<CacheManager>("null"));
        }
    }
}